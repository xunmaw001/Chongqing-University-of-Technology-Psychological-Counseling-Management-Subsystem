    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(examredetails !=null){
            ...
            BeanUtils.copyProperties( examredetails , view );//把实体数据重构到view中
                ...
                //级联表
                XueshengEntity xuesheng = xueshengService.selectById(examredetails.getXueshengId());
                if(xuesheng != null){
...
//                            examredetailsEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
