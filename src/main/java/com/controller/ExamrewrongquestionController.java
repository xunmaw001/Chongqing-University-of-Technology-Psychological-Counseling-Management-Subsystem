    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(examrewrongquestion !=null){
            ...
            BeanUtils.copyProperties( examrewrongquestion , view );//把实体数据重构到view中
                ...
                //级联表
                XueshengEntity xuesheng = xueshengService.selectById(examrewrongquestion.getXueshengId());
                if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody ExamrewrongquestionEntity examrewrongquestion, HttpServletRequest request){
        ...
        if(false)
            ...
            examrewrongquestion.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<ExamrewrongquestionEntity> queryWrapper = new EntityWrapper<ExamrewrongquestionEntity>()
            .eq("xuesheng_id", examrewrongquestion.getXueshengId())
...
//                            examrewrongquestionEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
