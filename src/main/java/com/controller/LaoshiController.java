    ...
    */
    ...
    public R save(@RequestBody LaoshiEntity laoshi, HttpServletRequest request){
        ...
        if(laoshiEntity==null){
            ...
            return R.error(511,"账户或者心理咨询老师手机号已经被使用");
        }
    }
...
//                            laoshiEntity.setLaoshiUuidNumber(data.get(0));                    //心理咨询老师编号 要改的
//                            laoshiEntity.setLaoshiName(data.get(0));                    //心理咨询老师姓名 要改的
//                            laoshiEntity.setLaoshiPhone(data.get(0));                    //心理咨询老师手机号 要改的
//                            laoshiEntity.setLaoshiPhoto("");//详情和图片
//                            laoshiEntity.setLaoshiShanchang(data.get(0));                    //擅长 要改的
//                            laoshiEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            laoshiEntity.setLaoshiEmail(data.get(0));                    //电子邮箱 要改的
//                            laoshiEntity.setLaoshiText(data.get(0));                    //心理咨询老师介绍 要改的
//                            laoshiEntity.setCreateTime(date);//时间
                        ...
                        if(laoshiEntities_laoshiUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [心理咨询老师编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //心理咨询老师手机号
                        ...
                        if(laoshiEntities_laoshiPhone.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [心理咨询老师手机号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(laoshi.getId(),username, "laoshi", "心理咨询老师");
        R r = R.ok();
        r.put("token", token);
        r.put("role","心理咨询老师");
...
//    	ValidatorUtils.validateEntity(user);
        ...
        LaoshiEntity laoshiEntity = laoshiService.selectOne(queryWrapper);
        if(laoshiEntity != null)
            return R.error("账户或者心理咨询老师手机号已经被使用");
        laoshi.setCreateTime(new Date());
        laoshiService.insert(laoshi);
        return R.ok();
    }
