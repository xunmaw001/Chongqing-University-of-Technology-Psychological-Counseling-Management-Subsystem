        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div>
                        <div v-for="(item,index) in laoshiList" v-bind:key="index" class="col-md-3 col-sm-3 col-xs-6 w3gallery-grids">
                            <div class="imghvr-hinge-right figure" style="width: 100%" @click="jumpCheck('../laoshi/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                <img :src="item.laoshiPhoto?item.laoshiPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                <div class="agile-figcaption">
                                    <h4>{{item.laoshiName}}</h4>
                                    <h4 v-if="item.laoshiNewMoney">
                                        {{item.laoshiNewMoney}} RMB
                                    </h4>
                                    <h4 v-else>
                                        {{item.laoshiValue}}
                                    </h4>
