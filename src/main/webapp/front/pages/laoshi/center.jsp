				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiUuidNumber" id="laoshiUuidNumber" lay-verify="required" placeholder="心理咨询老师编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiName" id="laoshiName" lay-verify="required" placeholder="心理咨询老师姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiPhone" id="laoshiPhone"  lay-verify="required|phone"   placeholder="心理咨询老师手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiShanchang" id="laoshiShanchang" lay-verify="required" placeholder="擅长" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiText" id="laoshiText" lay-verify="required" placeholder="心理咨询老师介绍" autocomplete="off" class="layui-input">
							</div>
						</div>
