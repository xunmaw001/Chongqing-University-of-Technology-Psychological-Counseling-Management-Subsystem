            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">心理咨询老师展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="laoshiUuidNumber" id="laoshiUuidNumber" placeholder="心理咨询老师编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="laoshiName" id="laoshiName" placeholder="心理咨询老师姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                ...
                <div class="ng-inside-box ng-fault ng-container" aos="fade-up">
                    <%--<div class="container">--%>
                        <div class="row mb-4">
                            <div v-for="(item,index) in dataList" v-bind:key="index" class="col-lg-3 col-md-6 probootstrap-animate mb-3">
                                <a @click="jumpCheck('../laoshi/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="probootstrap-thumbnail">
                                    <img :src="item.laoshiPhoto?item.laoshiPhoto.split(',')[0]:''" class="img-fluid" style="height: 350px;width:100%;" />
                                    <h4>
                                        名称:{{item.laoshiName}}
                                        <br />
                                        <p v-if="item.laoshiNewMoney != null" >价格:￥{{item.laoshiNewMoney}}</p>
                                    </h4>
                                </a>
                            </div>
                        </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#laoshiUuidNumber').val() != null && jquery('#laoshiUuidNumber').val() != "" && jquery('#laoshiUuidNumber').val() != "null" ) {
                param['laoshiUuidNumber'] = jquery('#laoshiUuidNumber').val();
            }
