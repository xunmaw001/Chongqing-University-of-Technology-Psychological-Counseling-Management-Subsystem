            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">心理咨询老师编号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="laoshiUuidNumber" id="laoshiUuidNumber"  placeholder="心理咨询老师编号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">心理咨询老师姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="laoshiName" id="laoshiName"  placeholder="心理咨询老师姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">心理咨询老师手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="laoshiPhone" id="laoshiPhone"  lay-verify="phone|required"   placeholder="心理咨询老师手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="laoshiShanchang" id="laoshiShanchang"  placeholder="擅长"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
...
<!-- 邮箱 -->
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">心理咨询老师介绍:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="laoshiText" id="laoshiText"  placeholder="心理咨询老师介绍"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
