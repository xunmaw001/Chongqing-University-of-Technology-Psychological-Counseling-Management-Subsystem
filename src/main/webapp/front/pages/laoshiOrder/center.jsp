    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiOrderUuidNumber" id="laoshiOrderUuidNumber" lay-verify="required" placeholder="预约流水号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yuyueTime" id="yuyueTime"  lay-verify="required|date"   placeholder="预约日期" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiOrderHao" id="laoshiOrderHao" lay-verify="required" placeholder="当天的号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="laoshiOrderYesnoTypes" id="laoshiOrderYesnoTypes">
                                    <option v-for="item in laoshiOrderYesnoTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="laoshiOrderYesnoText" id="laoshiOrderYesnoText" lay-verify="required" placeholder="审核状态" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zixunjieguoText" id="zixunjieguoText" lay-verify="required" placeholder="咨询结果" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`laoshiOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
