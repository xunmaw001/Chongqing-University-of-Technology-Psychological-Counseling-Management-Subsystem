...
<!-- 唯一uuid -->
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input  type="text" name="xueshengUuidNumber" id="xueshengUuidNumber"  lay-verify="required"   placeholder="学生编号" autocomplete="off" class="layui-input" readonly="readonly">
                </div>
            </div>
            <div class="layui-form-item" pane>
