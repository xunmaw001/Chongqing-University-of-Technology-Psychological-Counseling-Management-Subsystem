				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xueshengUuidNumber" id="xueshengUuidNumber" lay-verify="required" placeholder="学生编号" autocomplete="off" class="layui-input">
							</div>
						</div>
