            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">学生编号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xueshengUuidNumber" id="xueshengUuidNumber"  placeholder="学生编号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
