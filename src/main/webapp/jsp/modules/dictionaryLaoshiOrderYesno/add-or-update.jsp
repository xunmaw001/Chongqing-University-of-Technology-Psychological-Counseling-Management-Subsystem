    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑预约状态</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">预约状态管理</li>
                        <li class="breadcrumb-item active">编辑预约状态</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">预约状态表信息</h3>
...
<script>
    ...
    var tableName = "dictionaryLaoshiOrderYesno";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "laoshi_order_yesno_types";
            data["dicName"] = "预约状态";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"laoshi_order_yesno_types"}, (res) => {
                if(res.code == 0){
