...
<!--/Pre Loader -->
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="exampaperNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="试卷名称" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            laoshiNameCell.innerHTML = item.xueshengName;
            ...
            //心理评分
            var xinlipingfenCell = document.createElement('td');
            if(item.totalScore<60){
                xinlipingfenCell.innerHTML = '差';
            }else if(item.totalScore<80){
                xinlipingfenCell.innerHTML = '一般';
            }else if(item.totalScore<100){
                xinlipingfenCell.innerHTML = '优秀';
            }else{
                xinlipingfenCell.innerHTML = '超过100分';
            }
            row.appendChild(xinlipingfenCell);
