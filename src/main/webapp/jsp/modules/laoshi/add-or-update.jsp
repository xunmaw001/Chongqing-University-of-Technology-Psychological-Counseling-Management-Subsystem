    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑心理咨询老师</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">心理咨询老师管理</li>
                        <li class="breadcrumb-item active">编辑心理咨询老师</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">心理咨询老师信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 laoshiShanchangDiv">
                                        <label>擅长</label>
                                        <input style="width: 450px" id="laoshiShanchang" name="laoshiShanchang" class="form-control"
                                               placeholder="擅长">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 laoshiTextDiv">
                                        <label>心理咨询老师介绍</label>
                                        <textarea style="width: 450px"  id="laoshiText" name="laoshiText" class="form-control"placeholder="心理咨询老师介绍"></textarea>
                                    </div>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                laoshiUuidNumber: "心理咨询老师编号不能为空",
                laoshiName: "心理咨询老师姓名不能为空",
                laoshiPhone: "心理咨询老师手机号不能为空",
                laoshiPhoto: "心理咨询老师头像不能为空",
                laoshiShanchang: "擅长不能为空",
                sexTypes: "性别不能为空",
                laoshiEmail: "电子邮箱不能为空",
                laoshiText: "心理咨询老师介绍不能为空",
            }
        }).form();
    }
