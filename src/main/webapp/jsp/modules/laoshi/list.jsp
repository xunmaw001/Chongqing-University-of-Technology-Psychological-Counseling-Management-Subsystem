...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">心理咨询老师管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">心理咨询老师列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">心理咨询老师列表</h3>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="laoshiUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="心理咨询老师编号" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //擅长
            var laoshiShanchangCell = document.createElement('td');
            laoshiShanchangCell.innerHTML = item.laoshiShanchang;
            row.appendChild(laoshiShanchangCell);
            ...
            //心理咨询老师介绍
            var laoshiTextCell = document.createElement('td');
            laoshiTextCell.innerHTML = item.laoshiText;
            row.appendChild(laoshiTextCell);
