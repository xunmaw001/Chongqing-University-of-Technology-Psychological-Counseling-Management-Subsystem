...
<body style="background-image:url('/xinlizixunguanli/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input id="laoshiText" name="laoshiText" class="form-control"
                                           placeholder="心理咨询老师介绍">
                                </div>
                                <div class="form-group col-md-12">
