    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">每天每个老师预约次数统计</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">每天每个老师预约次数管理</li>
                        <li class="breadcrumb-item active">每天每个老师预约次数统计</li>
                    </ol>
                </div>
            </div>
        </div>
...
//柱状图 求和 已成功使用
        //start
        let yAxisName = "预约人数";//根据查询数据具体改(单列要改,多列不改)
        let xAxisName = "月份";
        let series = [];//具体数据值
